...
public class CategoryController {
	...
	public String newCategory(Model model) {
		...
		return "categories/newcategory_form";
	}
	...
	public String saveCategory(Category category,
		...
		ra.addFlashAttribute("message", "Danh mục: đã lưu thành công!");
	...
	public String editCategory(@PathVariable(name = "id") Integer id, Model model,
		...
		try {
			...
			model.addAttribute("listCategories", listCategories);
			model.addAttribute("pageTitle", "Chỉnh sửa thông tin danh mục: " + category.getName());
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id,
		...
		String message = "Trạng thái danh mục (ID: " + id + ") đã được " + status;
