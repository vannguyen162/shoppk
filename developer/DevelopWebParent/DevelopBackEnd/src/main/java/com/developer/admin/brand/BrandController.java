...
//		System.out.println("sort oder: " + sortDir);
	...
	public String saveBrand(Brand brand, @RequestParam("uploadfile") MultipartFile multipartFile,
		...
		ra.addFlashAttribute("message", "Thương hiệu: đã lưu thành công!");
	...
	public String editBrand(@PathVariable(name = "id") Integer id, Model model,
		...
		try {
			...
			model.addAttribute("listCategories", listCategories);
			model.addAttribute("pageTitle", "Chỉnh sửa thông tin thương hiệu: " + id);
	...
	public String deleteBrand(@PathVariable(name = "id") Integer id,
		...
		try {
			...
			redirectAttributes.addFlashAttribute("message", "Đã xóa thương hiệu: " + id);
		} catch (BrandNotFoundException ex) {
