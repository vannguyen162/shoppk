...
function formatOrderAmounts(){
	formatNumberForFiled(fieldProductCost);
	formatNumberForFiled(fieldSubtotal);
	formatNumberForFiled(fieldShippingCost);
	formatNumberForFiled(fieldTax);
	formatNumberForFiled(fieldTotal);
}

function formatNumberForFiled(fieldRef){
