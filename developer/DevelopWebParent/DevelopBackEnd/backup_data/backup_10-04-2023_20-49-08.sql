...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `test` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `ado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `address_line_1` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `address_line_2` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `backup` (
  ...
  `path_file` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `backup` VALUES (1,0,'backup_data/backup_10-04-2023_20-40-54.sql','2023-04-10 20:40:55.180000');
...
CREATE TABLE `client_info` (
  ...
  `device_infor` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customer_activity` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ativity` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `log_in` datetime(6) DEFAULT NULL,
  `log_out` datetime(6) DEFAULT NULL,
  `time_ativity` datetime(6) DEFAULT NULL,
  `customer_id` int DEFAULT NULL,
  `url_log` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `notice` VALUES (9,'2023-04-07 23:48:22.646000',_binary '','2023-05-30','<p>xin ch&agrave;o tất cả ae đang c&oacute; mặt</p>',NULL,'xin chào tất cả ae đang có mặt','2023-04-07','2023-04-07 23:48:22.646000','Nghia',_binary '\0');
...
-- Dump completed on 2023-04-10 20:49:08
