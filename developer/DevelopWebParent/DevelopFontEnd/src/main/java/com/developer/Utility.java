...
public class Utility {
	...
	public static JavaMailSenderImpl prepareMailSender(EmailSettingBag settings) {
		...
		Properties mailpProperties = new Properties();
		mailpProperties.setProperty("mail.smtp.auth", settings.getSmtpAuth());
		mailpProperties.setProperty("mail.smtp.starttls.enable", settings.getSmtpSecured());
		
		mailSender.setJavaMailProperties(mailpProperties);
